...
Посты представлены тупо в виде `.md` файлов, где название состоит из двух частей, разделённых `_`: даты и названия. Название пока не играет роли, но, возможно, потом я добавлю ссылки на конкретные посты, и эти названия будут служить URL. Дата — та, которая будет отображаться на сайте, то есть можно поставить любую :).
